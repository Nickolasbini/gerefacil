                    ...
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                    <img class="h-8 w-8 rounded-full object-cover profile-photo" style="display:none;" src="{{URL::asset('/images/account-avatar.svg')}}" alt="{{ Auth::user()->name }}" />
                                </button>
                            @else
                        ...
                        <x-slot name="content">
                            ...
                            <div class="block px-4 py-2 text-xs text-gray-400">
                                <?= ucfirst(translate('manage account')) ?>
                            </div>

                            <x-jet-dropdown-link href="{{ route('profile.show') }}">
                                <?= ucfirst(translate('profile')) ?>
                            </x-jet-dropdown-link>
            ...
            <div class="flex items-center px-4">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="shrink-0 mr-3">
                        <img class="h-10 w-10 rounded-full object-cover profile-photo" style="display:none;" src="{{URL::asset('/images/account-avatar.svg')}}" alt="{{ Auth::user()->name }}" />
                    </div>
                @endif
...
<script>
    ...
    $.ajax({
        ...
        success: function(result){
            if(result != ''){
                var src = 'data:image/jpg;base64,' + result;
